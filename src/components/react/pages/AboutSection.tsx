    ...
    <section className="section">
      <div className="container about-main">
        ...
        <div className="motion-reveal">
          ...
          <a className="about-link" href="https://www.linkedin.com/in/julio-alberto-marte-balbuena-5454a072" target="_blank" rel="noopener noreferrer">LinkedIn <ArrowRight size={16} aria-hidden="true" /></a>
        </div>
      </div>
    </section>
  );
