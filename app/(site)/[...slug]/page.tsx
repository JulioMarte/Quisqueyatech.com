...
function resolveRoute(parts: string[]): Route | null {
  ...
  const fixed: Record<string, Route> = {
    ...
    "/soluciones": { kind: "solutions", locale: "es" },
    "/en/solutions": { kind: "solutions", locale: "en" },
    "/soluciones/automatizacion": { kind: "automation", locale: "es" },
    "/en/solutions/automation": { kind: "automation", locale: "en" },
    "/soluciones/agentes-de-ia": { kind: "agents", locale: "es" },
    "/en/solutions/ai-agents": { kind: "agents", locale: "en" },
    "/soluciones/software-e-integraciones": { kind: "software", locale: "es" },
    "/en/solutions/software-and-integrations": { kind: "software", locale: "en" },
    "/soluciones/clinicas": { kind: "clinics", locale: "es" },
    "/en/solutions/clinics": { kind: "clinics", locale: "en" },
    "/como-trabajamos": { kind: "method", locale: "es" },
    "/en/how-we-work": { kind: "method", locale: "en" },
    "/evaluacion": { kind: "assessment", locale: "es" },
    "/en/assessment": { kind: "assessment", locale: "en" },
    "/evaluacion/ahora": { kind: "assessmentNow", locale: "es" },
    "/en/assessment/now": { kind: "assessmentNow", locale: "en" },
    "/evaluacion/agendar": { kind: "assessmentSchedule", locale: "es" },
    "/en/assessment/schedule": { kind: "assessmentSchedule", locale: "en" },
    "/recursos": { kind: "resources", locale: "es" },
    "/en/recursos": { kind: "resources", locale: "en" },
  ...
  if (resource)
    return { kind: "resources", locale: resource[1] ? "en" : "es", postSlug: resource[2] };
  return null;
}
...
export async function generateMetadata({
  ...
  if (route.postSlug) {
    ...
    const counterpart = post.translationKey
      ? (await getPublishedPosts(isEn ? "es" : "en")).find(
      ...
      alternates: {
        ...
        languages: counterpart
          ? {
              ...
              [isEn ? "es" : "en"]:
                `${brand.siteUrl}${isEn ? "" : "/en"}/recursos/${counterpart.slug}`,
            }
          : undefined,
      },
      openGraph: {
